...
for(int i=1;i<=tinggi;i=i+1)
    ...
    cout<< "==================================="<<endl;
            ...
            else if (pilih==skill)
            {
             ...
             int randomspawnx1=rand()%2;
             int randomspawnx2=rand()%2;
             if(randomspawnx1==0 && randomspawnx2==0)
                {
                 xMusuh+=3;
                }
             else if(randomspawnx1==0 && randomspawnx2==1)
                {
                 xMusuh-=3;
                }
             else if(randomspawnx1==1 && randomspawnx2==0)
                {
                 xMusuh-=3;
                }
             else if(randomspawnx1==1 && randomspawnx2==1)
                {
                 xMusuh+=3;
                }
             ...
             int randomspawny1=rand()%2;
             int randomspawny2=rand()%2;
             if(randomspawny1==0 && randomspawny2==0)
                {
                 yMusuh+=3;
                }
             else if(randomspawny1==0 && randomspawny2==1)
                {
                 yMusuh-=3;
                }
             else if(randomspawny1==1 && randomspawny2==0)
                {
                 yMusuh-=3;
                }
             else if(randomspawny1==1 && randomspawny2==1)
                {
                 yMusuh+=3;
                }
