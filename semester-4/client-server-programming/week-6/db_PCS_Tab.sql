...
insert into liga values('SP005','Divisiones Regionales','ESP',5);
...
insert into club values('LI002','Lille',to_date('1944','YYYY'),'FR001');
...
insert into h_transaksi values('TRANS036','MU001','CH001',20000000,to_date('01-09-2018','DD-MM-YYYY'));
insert into h_transaksi values('TRANS037','CH001','MU001',20000000,to_date('01-09-2017','DD-MM-YYYY'));
insert into h_transaksi values('TRANS038','MU001','CH001',20000000,to_date('01-09-2016','DD-MM-YYYY'));
insert into h_transaksi values('TRANS039','MC001','RM001',20000000,to_date('01-09-2012','DD-MM-YYYY'));
insert into h_transaksi values('TRANS040','RM001','MC001',20000000,to_date('01-09-2013','DD-MM-YYYY'));
insert into h_transaksi values('TRANS041','MC001','RM001',20000000,to_date('01-09-2014','DD-MM-YYYY'));
...
insert into club_manager values('LI002','MAN021');
