...
namespace App_M5 {
    public partial class personel : Form {
        ...
        private void insertData(List<string> data, string role) {
            ...
            if (role == "player") {
                string insert = "INSERT INTO player VALUES ('" + data[0] + "', '" + data[1] + "', TO_DATE('" + date + "', 'DD-MM-YYYY'), " +
                ...
                insert[0] = "INSERT INTO manager VALUES ('" + data[0] + "', '" + data[1] + "', TO_DATE('" + date + "', 'DD-MM-YYYY'), " +
                                "'" + data[4] + "', '" + data[5] + "')";
        ...
        private void updateData(List<string> data, string role) {
            ...
            if (role == "player") {
                string update = "UPDATE player " +
                                "SET nama_player = '" + data[1] + "', dob_player = TO_DATE('" + date + "', 'DD-MM-YYYY'), " +
                ...
                update[0] = "UPDATE manager " +
                            "SET nama_manager = '" + data[1] + "', dob_manager = TO_DATE('" + date + "', 'DD-MM-YYYY'), " +
